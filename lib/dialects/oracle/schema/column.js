...
// Column Compiler
// -------
undefined.modifiers = ['defaultTo', 'checkIn', 'nullable', 'comment'];
...
comment = function (comment) {
  this.pushAdditional(function () {
    this.pushQuery('comment on column ' + this.tableCompiler.tableName() + '.' + this.formatter.wrap(this.args[0]) + ' is \'' + (comment || '') + '\'');
  }, comment);
};
